    ...
    <div className="rent">
        ...
        >
          ...
          <div className="rent__container">
            ...
            <p>
              ...
              details. The Eugene, Manhattan West’s newest rental offering in
      ...
      <div className="rent__cart">
        ...
        >
          ...
          <div className="rent__container">
            ...
            <p>
              Gross rent is $4,625. We are currently offering 2 Months FREE on a
              12 Month lease for leases starting immediately.
            </p>
            <div className="rent__icons">
              <div className="rent--bed">
                <p>
      ...
      <div className="rent__cart">
        ...
        <div className="rent__container">
          ...
          <p>
            505 W 37th St is an icon of luxury Midtown Manhattan living. The
            northern ambassador to Hudson Yards, 505W37‚
          </p>
          <div className="rent__icons">
            <div className="rent--bed">
              <p>
